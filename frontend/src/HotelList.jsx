    ...
    <div style={{ padding: "30px", backgroundColor: "#f8f8f8", fontFamily: "Poppins, sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "20px" }}>
        {filteredHotels.map((hotel) => (
          <div key={hotel._id} style={{ background: "#fff", borderRadius: "8px", padding: "15px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
            <img
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "10px" }}>
              ...
              {/* {user && (
                <button
                  onClick={() => alert("Booking logic will go here")}
                  style={{
                    padding: "6px 12px",
      ...
      {filteredHotels.length === 0 && (
        <p style={{ textAlign: "center", marginTop: "30px", color: "#999" }}>No hotels match your filters.</p>
      )}
    </div>
  );
}
